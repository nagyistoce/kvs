...
protected:
    ...
    const kvs::Real32 random_number( void ) const;
};
 ...
 *  @param  local_point [in] coordinate value in the local
 */
/*===========================================================================*/
template <typename T>
 ...
 *  @param  global_point [in] coordinate value in the global
 */
/*===========================================================================*/
template <typename T>
...
/*===========================================================================*/
template <typename T>
inline const kvs::Real32 CellBase<T>::random_number( void ) const
{
