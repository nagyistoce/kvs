...
//    const GLfloat screen_scale_y = m_height * 0.5f;
    ...
    m_shader_program.setUniform( "densityFactor", densityFactor );
    ...
    m_shader_program.setUniform( "circle_threshold", circle_threshold );
...
{
    const std::string vert_code = "SR_point.vert";
    const std::string frag_code = "SR_point.frag";
