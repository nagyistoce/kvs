...
StochasticMultipleTetrahedraRenderer::StochasticMultipleTetrahedraRenderer():
    m_engine( NULL )
{
    this->set_rendering_engine( new kvs::StochasticMultipleTetrahedraEngine() );
}
...
//    this->attachObjects( volume1, volume2 );
    this->set_rendering_engine( new kvs::StochasticMultipleTetrahedraEngine( volume1, volume2 ) );
}
...
{
    typedef kvs::StochasticMultipleTetrahedraEngine Engine;
    Engine* engine = static_cast<Engine*>( BaseClass::m_rendering_engines[0] );
    engine->setTransferFunction( transfer_function, index );
}

void StochasticMultipleTetrahedraRenderer::set_rendering_engine( kvs::StochasticMultipleTetrahedraEngine* rendering_engine )
{
