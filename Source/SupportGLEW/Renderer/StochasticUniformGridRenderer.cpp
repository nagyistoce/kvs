...
{
    BaseClass::setRenderingEngine( new kvs::glew::StochasticUniformGridEngine() );
}
...
{
    BaseClass::setRenderingEngine( new kvs::glew::StochasticUniformGridEngine( object ) );
}
...
{
    typedef kvs::glew::StochasticUniformGridEngine Engine;
