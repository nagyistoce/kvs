...
{
#if defined( KVS_GLEW_STOCHASTIC_TETRAHEDRA_ENGINE__EMBEDDED_SHADER )
    const std::string vert_code = kvs::glew::glsl::StochasticRenderingEngine::Vertex::uniform_grid;
    const std::string frag_code = kvs::glew::glsl::StochasticRenderingEngine::Fragment::uniform_grid;
#else
    const std::string vert_code = "StochasticRenderingEngine/uniform_grid.vert";
