 ...
 *  @brief  Example program for kvs::glew::StochasticMultivariateTetrahedraRenderer class.
 */
/*----------------------------------------------------------------------------
 *
...
int main( int argc, char** argv )
{
    ...
    kvs::glew::StochasticMultivariateTetrahedraRenderer* renderer = new kvs::glew::StochasticMultivariateTetrahedraRenderer();
