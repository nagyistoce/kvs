 ...
 */
/*===========================================================================*/
kvs::XMLNode::SuperClass* PointObjectTag::node( void )
{
    return( m_node );
}
 ...
 */
/*===========================================================================*/
const kvs::XMLNode::SuperClass* PointObjectTag::node( void ) const
{
    return( m_node );
}
...
{
    m_node = kvs::XMLNode::FindChildNode( parent, "PointObject" );
    if ( !m_node )
    {
        kvsMessageError("Cannot find <PointObject>.");
        return( false );
    }
...
{
    kvs::XMLElement element("PointObject");

    m_node = parent->InsertEndChild( element );
    if( !m_node )
    {
        kvsMessageError("Cannot insert <PointObject>.");
        return( false );
    }
