...
int PreIntegrationTable::sizeDepth() const
{
    return m_size_depth;
}
...
void PreIntegrationTable::download()
{
    ...
    m_table_texture.load( m_size_scalar, m_size_scalar, m_size_depth, m_table );
 ...
 */
/*===========================================================================*/
void PreIntegrationTable::bind()
{
    m_table_texture.bind();
}

void PreIntegrationTable::unbind()
{
    m_table_texture.unbind();
}

void PreIntegrationTable::release()
{
    m_table_texture.release();
}

bool PreIntegrationTable::isTexture()
{
    return m_table_texture.isValid();
}

bool PreIntegrationTable::isDownloaded()
{
    return m_table_texture.isLoaded();
}
