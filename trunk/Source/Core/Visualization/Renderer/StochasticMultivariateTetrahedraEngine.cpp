...
{
    const std::string vert_code = "SR_multivariate_tetrahedra.vert";
    const std::string geom_code = "SR_multivariate_tetrahedra.geom";
    const std::string frag_code = "SR_multivariate_tetrahedra.frag";
