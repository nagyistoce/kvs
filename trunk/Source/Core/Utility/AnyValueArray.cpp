...
template<> AnyValueArray::AnyValueArray( const kvs::Int8* values, size_t nvalues );
template<> AnyValueArray::AnyValueArray( const kvs::UInt8* values, size_t nvalues );
template<> AnyValueArray::AnyValueArray( const kvs::Int16* values, size_t nvalues );
template<> AnyValueArray::AnyValueArray( const kvs::UInt16* values, size_t nvalues );
template<> AnyValueArray::AnyValueArray( const kvs::Int32* values, size_t nvalues );
template<> AnyValueArray::AnyValueArray( const kvs::UInt32* values, size_t nvalues );
template<> AnyValueArray::AnyValueArray( const kvs::Int64* values, size_t nvalues );
template<> AnyValueArray::AnyValueArray( const kvs::UInt64* values, size_t nvalues );
template<> AnyValueArray::AnyValueArray( const kvs::Real32* values, size_t nvalues );
template<> AnyValueArray::AnyValueArray( const kvs::Real64* values, size_t nvalues );
...
template<> void* AnyValueArray::allocate<kvs::Int8>( size_t nvalues );
template<> void* AnyValueArray::allocate<kvs::UInt8>( size_t nvalues );
template<> void* AnyValueArray::allocate<kvs::Int16>( size_t nvalues );
template<> void* AnyValueArray::allocate<kvs::UInt16>( size_t nvalues );
template<> void* AnyValueArray::allocate<kvs::Int32>( size_t nvalues );
template<> void* AnyValueArray::allocate<kvs::UInt32>( size_t nvalues );
template<> void* AnyValueArray::allocate<kvs::Int64>( size_t nvalues );
template<> void* AnyValueArray::allocate<kvs::UInt64>( size_t nvalues );
template<> void* AnyValueArray::allocate<kvs::Real32>( size_t nvalues );
template<> void* AnyValueArray::allocate<kvs::Real64>( size_t nvalues );
...
template<> void AnyValueArray::deepCopy<kvs::Int8>( const kvs::Int8* values, size_t nvalues );
template<> void AnyValueArray::deepCopy<kvs::UInt8>( const kvs::UInt8* values, size_t nvalues );
template<> void AnyValueArray::deepCopy<kvs::Int16>( const kvs::Int16* values, size_t nvalues );
template<> void AnyValueArray::deepCopy<kvs::UInt16>( const kvs::UInt16* values, size_t nvalues );
template<> void AnyValueArray::deepCopy<kvs::Int32>( const kvs::Int32* values, size_t nvalues );
template<> void AnyValueArray::deepCopy<kvs::UInt32>( const kvs::UInt32* values, size_t nvalues );
template<> void AnyValueArray::deepCopy<kvs::Int64>( const kvs::Int64* values, size_t nvalues );
template<> void AnyValueArray::deepCopy<kvs::UInt64>( const kvs::UInt64* values, size_t nvalues );
template<> void AnyValueArray::deepCopy<kvs::Real32>( const kvs::Real32* values, size_t nvalues );
template<> void AnyValueArray::deepCopy<kvs::Real64>( const kvs::Real64* values, size_t nvalues );
