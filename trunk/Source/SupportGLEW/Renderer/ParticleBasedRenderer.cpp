...
//#include "Shader.h" // SAKAMOTO-TANAKA
#endif
#include <algorithm>
 ...
 */
/*===========================================================================*/
ParticleBasedRenderer::Particles::Particles( void ):
    m_nvertices( 0 ),
    m_indices( NULL ),
    m_coords( NULL ),
    m_normals( NULL ),
 ...
 */
/*===========================================================================*/
void ParticleBasedRenderer::Particles::release( void )
{
 ...
 */
/*===========================================================================*/
const bool ParticleBasedRenderer::Particles::hasIndex( void ) const
{
 ...
 */
/*===========================================================================*/
const bool ParticleBasedRenderer::Particles::hasNormal( void ) const
{
 ...
 */
/*===========================================================================*/
const size_t ParticleBasedRenderer::Particles::nvertices( void ) const
{
    return( m_nvertices );
}
 ...
 */
/*===========================================================================*/
const size_t ParticleBasedRenderer::Particles::byteSizePerVertex( void ) const
{
 ...
 */
/*===========================================================================*/
const size_t ParticleBasedRenderer::Particles::byteSize( void ) const
{
 ...
 */
/*===========================================================================*/
const ParticleBasedRenderer::IndexType* ParticleBasedRenderer::Particles::indices( void ) const
{
    return( m_indices );
}
 ...
 */
/*===========================================================================*/
ParticleBasedRenderer::IndexType* ParticleBasedRenderer::Particles::indices( void )
{
    return( m_indices );
}
 ...
 */
/*===========================================================================*/
const ParticleBasedRenderer::CoordType* ParticleBasedRenderer::Particles::coords( void ) const
{
    return( m_coords );
}
 ...
 */
/*===========================================================================*/
ParticleBasedRenderer::CoordType* ParticleBasedRenderer::Particles::coords( void )
{
    return( m_coords );
}
 ...
 */
/*===========================================================================*/
const ParticleBasedRenderer::NormalType* ParticleBasedRenderer::Particles::normals( void ) const
{
    return( m_normals );
}
 ...
 */
/*===========================================================================*/
ParticleBasedRenderer::NormalType* ParticleBasedRenderer::Particles::normals( void )
{
    return( m_normals );
}
 ...
 */
/*===========================================================================*/
const ParticleBasedRenderer::ColorType* ParticleBasedRenderer::Particles::colors( void ) const
{
    return( m_colors );
}
 ...
 */
/*===========================================================================*/
ParticleBasedRenderer::ColorType* ParticleBasedRenderer::Particles::colors( void )
{
    return( m_colors );
}
 ...
 */
/*===========================================================================*/
ParticleBasedRenderer::Renderer::Renderer( void ):
    m_particles(NULL),
    m_start(0),
    m_count(0),
    m_off_index(0),
 ...
 */
/*===========================================================================*/
const size_t ParticleBasedRenderer::Renderer::download( kvs::glew::VertexBufferObject& vbo )
{
 ...
 */
/*===========================================================================*/
void ParticleBasedRenderer::Renderer::draw( void ) const
{
 ...
 */
/*===========================================================================*/
const size_t ParticleBasedRenderer::Renderer::nvertices( void ) const
{
    return( m_count );
}
 ...
 */
/*===========================================================================*/
const size_t ParticleBasedRenderer::Renderer::byteSizePerVertex( void ) const
{
 ...
 */
/*===========================================================================*/
const size_t ParticleBasedRenderer::Renderer::byteSize( void ) const
{
 ...
 */
/*===========================================================================*/
ParticleBasedRenderer::ParticleBasedRenderer( void ):
    m_ref_point( NULL )
{
 ...
 */
/*===========================================================================*/
void ParticleBasedRenderer::initialize( void )
{
    BaseClass::m_width = 0;
...
void ParticleBasedRenderer::disableLODControl( void )
{
    m_enable_lod = false;
    this->disableCoarseRendering();
}

void ParticleBasedRenderer::enableZooming( void )
{
 ...
 */
/*===========================================================================*/
void ParticleBasedRenderer::disableCoarseRendering( void )
{
 ...
 */
/*===========================================================================*/
void ParticleBasedRenderer::enableAccumulationBuffer( void )
{
 ...
 */
/*===========================================================================*/
void ParticleBasedRenderer::disableAccumulationBuffer( void )
{
    m_enable_accumulation_buffer = false;
}
 ...
 */
/*===========================================================================*/
void ParticleBasedRenderer::enableRandomTexture( void )
{
    m_enable_random_texture = true;
}
 ...
 */
/*===========================================================================*/
void ParticleBasedRenderer::disableRandomTexture( void )
{
 ...
 */
/*===========================================================================*/
const size_t ParticleBasedRenderer::subpixelLevel( void ) const
{
 ...
 */
/*===========================================================================*/
const size_t ParticleBasedRenderer::repetitionLevel( void ) const
{
 ...
 */
/*===========================================================================*/
const size_t ParticleBasedRenderer::randomTextureSize( void ) const
{
 ...
 */
/*===========================================================================*/
const size_t ParticleBasedRenderer::circleThreshold( void ) const
{
 ...
 */
/*===========================================================================*/
const bool ParticleBasedRenderer::isEnabledAccumulationBuffer( void ) const
{
 ...
 */
/*===========================================================================*/
const bool ParticleBasedRenderer::isEnabledRandomTexture( void ) const
{
 ...
 */
/*==========================================================================*/
void ParticleBasedRenderer::initialize_opengl( void )
{
/*
...
//        const std::string vert_code = kvs::glew::glsl::ParticleBasedRenderer::Vertex::resize;
//        const std::string frag_code = kvs::glew::glsl::ParticleBasedRenderer::Fragment::resize;
#else
...
//        const std::string vert_code = "ParticleBasedRenderer/resize.vert";
//        const std::string frag_code = "ParticleBasedRenderer/resize.frag";
#endif
 ...
 */
/*==========================================================================*/
void ParticleBasedRenderer::initialize_resize_texture( void )
{
 ...
 */
/*===========================================================================*/
void ParticleBasedRenderer::create_random_texture( void )
{
 ...
 */
/*==========================================================================*/
void ParticleBasedRenderer::align_particles( void )
{
 ...
 */
/*==========================================================================*/
void ParticleBasedRenderer::create_vertexbuffer( void )
{
    size_t memorysize = 0;
    if ( m_enable_pre_downloading )
    {
 ...
 */
/*==========================================================================*/
void ParticleBasedRenderer::setup_resize_shader(void)
{
