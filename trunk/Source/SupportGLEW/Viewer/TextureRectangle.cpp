 ...
 */
/*==========================================================================*/
const GLenum TextureRectangle::wrapS( void ) const
{
    return( m_wrap_s );
}
 ...
 */
/*==========================================================================*/
const GLenum TextureRectangle::wrapT( void ) const
{
    return( m_wrap_t );
}
 ...
 */
/*==========================================================================*/
const size_t TextureRectangle::width( void ) const
{
    return( m_width );
}
 ...
 */
/*==========================================================================*/
const size_t TextureRectangle::height( void ) const
{
    return( m_height );
}

const bool TextureRectangle::isDownloaded( void ) const
{
...
void TextureRectangle::create( const size_t width, const size_t height )
{
    ...
    glTexParameteri( GL_TEXTURE_RECTANGLE_ARB, GL_TEXTURE_MAG_FILTER, m_mag_filter );
    glTexParameteri( GL_TEXTURE_RECTANGLE_ARB, GL_TEXTURE_MIN_FILTER, m_min_filter );

    // Set the wrap methods.
    glTexParameteri( GL_TEXTURE_RECTANGLE_ARB, GL_TEXTURE_WRAP_S, m_wrap_s );
    glTexParameteri( GL_TEXTURE_RECTANGLE_ARB, GL_TEXTURE_WRAP_T, m_wrap_t );
 ...
 */
/*==========================================================================*/
unsigned int TextureRectangle::get_texture_memory_size_on_gpu( const GLenum proxy )
{
