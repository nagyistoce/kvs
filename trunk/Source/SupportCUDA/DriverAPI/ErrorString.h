 ...
 */
/*****************************************************************************/
#ifndef KVS__CUDA__DRIVERAPI__ERRORSTRING_H_INCLUDE
#define KVS__CUDA__DRIVERAPI__ERRORSTRING_H_INCLUDE
 ...
 */
/*===========================================================================*/
inline const char* ErrorString( const CUresult error )
{
    switch ( error )
    {
