...
{
    BaseClass::setRenderingEngine( new kvs::StochasticTetrahedraEngine() );
}
...
{
    BaseClass::setRenderingEngine( new kvs::StochasticTetrahedraEngine( object ) );
}
...
{
    typedef kvs::StochasticTetrahedraEngine Engine;
